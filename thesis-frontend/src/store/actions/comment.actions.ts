...
export const createCommentRequest = createAction('[ Comment ] CreateCommentRequest', props<{ comment: CommentInput, queryOptions: QueryOptions }>());
...
export const deleteCommentRequest = createAction('[ Comment ] DeleteCommentRequest', props<{ id: string, queryOptions: QueryOptions }>());

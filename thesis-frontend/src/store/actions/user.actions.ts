...
export const getUsersRequest = createAction('[ User ] GetUsersRequest', props<{ queryOptions: QueryOptions, token: string }>());
...
export const getUserRequest = createAction('[ User ] GetUserRequest', props<{ id: string, token: string }>());
...
export const createUserRequest = createAction('[ User ] CreateUserRequest', props<{ user: UserInput, queryOptions: QueryOptions, token: string }>());
...
export const editUserRequest = createAction('[ User ] EditUserRequest', props<{ id: string, user: UserInput, queryOptions?: QueryOptions, token: string }>());
...
export const deleteUserRequest = createAction('[ User ] DeleteUserRequest', props<{ id: string, queryOptions: QueryOptions, token: string }>());
...
export const getLoggedInUserRequest = createAction('[ User ] GetLoggedInUserRequest', props<{ token: string }>());
